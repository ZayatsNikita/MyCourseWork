...
{
    public class ServicetServices : Abstract.IServiceEntityRepository
    {
        ...
        public ServicetServices(string connectionString = @"Server=localhost;Port=3306;Database=work_fac;Uid=ForSomeCase;password=Kukrakuska713")  
        {
